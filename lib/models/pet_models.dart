...
class PetTypeConfig {
  ...
  final String name;
  final String emoji;
  final String imageAsset; // 宠物图片资源路径，如 'assets/pets/fox.png'
...
const List<PetTypeConfig> petTypes = [
  PetTypeConfig(
    ...
    name: '炭炭',
    emoji: '🦊',
    imageAsset: 'assets/pets/fox.png',
    personality: 'warm',
    type: 'fox',
    probability: 0.18,
  ...
  PetTypeConfig(
    ...
    name: '闪焰',
    emoji: '🐺',
    imageAsset: 'assets/pets/wolf.png',
    personality: 'driven',
    type: 'wolf',
    probability: 0.08,
  ...
  PetTypeConfig(
    ...
    name: '波波',
    emoji: '🐰',
    imageAsset: 'assets/pets/rabbit.png',
    personality: 'gentle',
    type: 'rabbit',
    probability: 0.12,
  ...
  PetTypeConfig(
    ...
    name: '滴露',
    emoji: '🦌',
    imageAsset: 'assets/pets/deer.png',
    personality: 'healing',
    type: 'deer',
    probability: 0.10,
  ...
  PetTypeConfig(
    ...
    name: '月影',
    emoji: '🖤',
    imageAsset: 'assets/pets/blackcat.png',
    personality: 'mysterious',
    type: 'blackcat',
    probability: 0.07,
    specialAbility: '神秘智者型，带你探索内心深处',
    greeting: '我是月影，黑夜中的指引者。你内心在寻找什么？',
  ),
  PetTypeConfig(
    id: 'panda',
    name: '雪团',
    emoji: '🐼',
    imageAsset: 'assets/pets/panda.png',
    personality: 'calm',
    type: 'panda',
    probability: 0.05,
  ...
  PetTypeConfig(
    ...
    name: '星光',
    emoji: '🦋',
    imageAsset: 'assets/pets/butterfly.png',
    personality: 'dreamy',
    type: 'butterfly',
    probability: 0.05,
